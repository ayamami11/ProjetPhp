	...
	<body>
		...
		<div class="container">
					...
					<form method="get" action="filieres.php" class="form-inline">
						<div class="form-group">													
							...
							<select name="NIVEAU" id="NIVEAU" class="form-control"
								...
								<option value="1" <?php echo $niveau=="1"?"selected":"" ?>>1</option>
								<option value="2" <?php echo $niveau=="2"?"selected":"" ?>>2</option>
								<option value="3" <?php echo $niveau=="3"?"selected":"" ?>>3</option>
								<option value="4l" <?php echo $niveau=="4"?"selected":"" ?>>4</option>
								<option value="5" <?php echo $niveau=="5"?"selected":"" ?>>Master</option>
							</select>
							...
							<?php if($_SESSION['utilisateur']['ROLE']=="ADMIN") {?>
								<a href="nouvelleFiliere.php"> <span class="glyphicon glyphicon-plus">Nouvelle filière</a>
							<?php } ?>	
						</div>
			...
			<div class="panel panel-primary ">
				<div class="panel-heading">Liste des classes (<?php echo $nbrF ?>&nbsp Classes) </div>
				<div class="panel-body">
